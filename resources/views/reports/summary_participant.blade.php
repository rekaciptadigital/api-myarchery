...
<table style="width: 100%; height: 70px;" border="0">
    ...
    <table style="width:100%;border: 1px solid black;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: right;">Rp{{ $data['fee'] ? number_format($data['fee']["individu"]) : '0' }}</td>
                <td style="text-align: right;">Rp{{ $data['fee'] ? number_format($data['fee']["team"]) : '0' }}</td>
                <td style="text-align: right;">Rp{{ $data['fee'] ? number_format($data['fee']["mix_team"]) : '0' }}</td>
                ...
                <td style="text-align: center;">{{ $data['total_sell'] ? $data['total_sell']["individu"] : '0' }}</td>
                <td style="text-align: center;">{{ $data['total_sell'] ? $data['total_sell']["team"] : '0' }}</td>
                <td style="text-align: center;">{{ $data['total_sell'] ? $data['total_sell']["mix_team"] : '0' }}</td>
                <td style="text-align: center;">{{ $data['remaining_quota'] ? $data['remaining_quota']["individu"] : '0' }}</td>
                <td style="text-align: center;">{{ $data['remaining_quota'] ? $data['remaining_quota']["team"] : '0' }}</td>
                <td style="text-align: center;">{{ $data['remaining_quota'] ? $data['remaining_quota']["mix_team"] : '0' }}</td>
                <td style="text-align: right;">Rp{{ $data['total_amount'] ? number_format($data['total_amount']) : '0' }}</td>     
            </tr>
            <?php 
    ...
    <table style="width:100%;border: 1px solid black;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: center;">{{ $data['total_participant'] ? $data['total_participant'] : '0' }}</td>
            </tr>
            <?php 
    ...
    <table style="width:100%;border: 1px solid black;">
        ...
        <tr >
                ...
                <th colspan="3" style="text-align: center; background: #FFFF00;"><strong>Individu Putra</strong></th>
                <th colspan="3" style="text-align: center; background: #a1a11a;"><strong>Individu Putri</strong></th>
                ...
                <th colspan="3" style="text-align: center; background: #FFFF00;"><strong>Beregu Campuran</strong></th>
            </tr>
                <?php
                    $no = 0;
                    $m_s = 0;
