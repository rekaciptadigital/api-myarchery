...
<body translate="no">
    <div class="page" style="break-after:page">
        ...
        <h1 style="text-align: center; margin-top: -1px;">{{ $category }}</h1>
        <div class="bracket">
                ...
                <div class="winners">
                    <div class="matchups">
                        <div class="matchup">
                            <div class="participants">
                                <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                    <span> {!! $round1member17 !!} <p class="log_output" style="background:black;">{!!
                                            $round1member17result !!}</p>
                                    </span>
                                </div>
                                <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                    <span> {!! $round1member18 !!} <p class="log_output" style="background:black;">{!!
                                            $round1member18result !!}</p>
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div class="matchup">
                            <div class="participants">
                                <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                    <span> {!! $round1member19 !!} <p class="log_output" style="background:black;">{!!
                                            $round1member3result !!}</p>
                                    </span>
                                </div>
                                <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                    <span> {!! $round1member20 !!} <p class="log_output" style="background:black;">{!!
                                            $round1member20result !!}</p>
                                    </span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="winners">
                    <div class="matchups">
                        <div class="matchup">
                            <div class="participants">
                                <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                    <span> {!! $round1member21 !!} <p class="log_output" style="background:black;">{!!
                                            $round1member21result !!}</p>
                                    </span>
                                </div>
                                <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                    <span> {!! $round1member22 !!} <p class="log_output" style="background:black;">{!!
                                            $round1member22result !!}</p>
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div class="matchup">
                            <div class="participants">
                                <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                    <span> {!! $round1member23 !!} <p class="log_output" style="background:black;">{!!
                                            $round1member23result !!}</p>
                                    </span>
                                </div>
                                <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                    <span> {!! $round1member24 !!} <p class="log_output" style="background:black;">{!!
                                            $round1member24result !!}</p>
                                    </span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="winners">
                    <div class="matchups">
                        <div class="matchup">
                            <div class="participants">
                                <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                    <span> {!! $round1member25 !!} <p class="log_output" style="background:black;">{!!
                                            $round1member25result !!}</p>
                                    </span>
                                </div>
                                <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                    <span> {!! $round1member26 !!} <p class="log_output" style="background:black;">{!!
                                            $round1member26result !!}</p>
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div class="matchup">
                            <div class="participants">
                                <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                    <span> {!! $round1member27 !!} <p class="log_output" style="background:black;">{!!
                                            $round1membe27result !!}</p>
                                    </span>
                                </div>
                                <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                    <span> {!! $round1member28 !!} <p class="log_output" style="background:black;">{!!
                                            $round1member28result !!}</p>
                                    </span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="winners">
                    <div class="matchups">
                        <div class="matchup">
                            <div class="participants">
                                <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                    <span> {!! $round1member29 !!} <p class="log_output" style="background:black;">{!!
                                            $round1member29result !!}</p>
                                    </span>
                                </div>
                                <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                    <span> {!! $round1member30 !!} <p class="log_output" style="background:black;">{!!
                                            $round1member30result !!}</p>
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div class="matchup">
                            <div class="participants">
                                <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                    <span> {!! $round1member31 !!} <p class="log_output" style="background:black;">{!!
                                            $round1member32result !!}</p>
                                    </span>
                                </div>
                                <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                    <span> {!! $round1member32 !!} <p class="log_output" style="background:black;">{!!
                                            $round1member32result !!}</p>
                                    </span>
                                </div>
                            </div>
                ...
                <div class="winners">
                    <div class="matchups">
                        <div class="matchup">
                            <div class="participants">
                                <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                    <span> {!! $round2member9 !!} <p class="log_output" style="background:black;">{!!
                                            $round2member9result !!}</p>
                                    </span>
                                </div>
                                <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                    <span> {!! $round2member10 !!} <p class="log_output" style="background:black;">{!!
                                            $round2member10result !!}</p>
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div class="matchup">
                            <div class="participants">
                                <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                    <span> {!! $round2member11 !!} <p class="log_output" style="background:black;">{!!
                                            $round2member11result !!}</p>
                                    </span>
                                </div>
                                <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                    <span> {!! $round2member12 !!} <p class="log_output" style="background:black;">{!!
                                            $round2member12result !!}</p>
                                    </span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="winners">
                    <div class="matchups">
                        <div class="matchup">
                            <div class="participants">
                                <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                    <span> {!! $round2member13 !!} <p class="log_output" style="background:black;">{!!
                                            $round2member13result !!}</p>
                                    </span>
                                </div>
                                <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                    <span> {!! $round2member14 !!} <p class="log_output" style="background:black;">{!!
                                            $round2member14result !!}</p>
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div class="matchup">
                            <div class="participants">
                                <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                    <span> {!! $round2member15 !!} <p class="log_output" style="background:black;">{!!
                                            $round2member15result !!}</p>
                                    </span>
                                </div>
                                <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                    <span> {!! $round2member16 !!} <p class="log_output" style="background:black;">{!!
                                            $round2member16result !!}</p>
                                    </span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="winners">
                    <div class="matchups">
                        <div class="matchup">
                            <div class="participants">
                                <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                    <span> {!! $round3member5 !!} <p class="log_output" style="background:black;">{!!
                                            $round3member5result !!}</p>
                                    </span>
                                </div>
                                <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                    <span> {!! $round3member6 !!} <p class="log_output" style="background:black;">{!!
                                            $round3member6result !!}</p>
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div class="matchup">
                            <div class="participants">
                                <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                    <span> {!! $round3member7 !!} <p class="log_output" style="background:black;">{!!
                                            $round3member7result !!}</p>
                                    </span>
                                </div>
                                <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                    <span> {!! $round3member8 !!} <p class="log_output" style="background:black;">{!!
                                            $round3member8result !!}</p>
                                    </span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="winners">
                    <div class="matchups">
                        ...
                        <div class="matchup">
                            <div class="participants">
                                <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                    <span> {!! $round6member1 !!} <p class="log_output" style="background:black;">{!!
                                            $round6member1result !!}</p>
                                    </span>
                                </div>
                                <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                    <span> {!! $round6member2 !!} <p class="log_output" style="background:black;">{!!
                                            $round6member2result !!}</p>
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="matchup">
                            <div class="participants">
                                <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                    <span> {!! $round4member3 !!} <p class="log_output" style="background:black;">{!!
                                            $round4member3result !!}</p>
                                    </span>
                                </div>
                                <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                    <span> {!! $round4member4 !!} <p class="log_output" style="background:black;">{!!
                                            $round4member4result !!}</p>
                                    </span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="winners">
                    <div class="matchups">
                        <div class="matchup">
                            <div class="participants">
                                <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                    <span> {!! $round5member1 !!} <p class="log_output" style="background:black;">{!!
                                            $round5member1result !!}</p>
                                    </span>
                                </div>
                                <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                    <span> {!! $round5member2 !!} <p class="log_output" style="background:black;">{!!
                                            $round5member2result !!}</p>
                                    </span>
                                </div>
                            </div>
                        </div>
