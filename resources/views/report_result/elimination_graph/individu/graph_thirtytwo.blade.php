                            ...
                            <div class="participants">
                                ...
                                @if ($round1member8status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32" style="background:black;">
                                            {!! $round1member8result !!}
                                        </span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        ...
                                        <span class="log_output_32" style="background:gray;">
                                            {!! $round1member8result !!}
                                        </span>
                                    </div>
                                @endif
                            ...
                            <div class="participants">
                                @if ($round1member13status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round1member13result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round1member13 !!}
                                        ...
                                        <span class="log_output_32"
                                            style="background:gray;">{!! $round1member13result !!}</span>
                                    </div>
                                @endif
                                ...
                                @if ($round1member14status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round1member14result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round1member14 !!}
                                        ...
                                        <span class="log_output_32"
                                            style="background:gray;">{!! $round1member14result !!}</span>
                                    </div>
                                @endif
                            </div>
                        </div>
                            ...
                            <div class="participants">
                                @if ($round1member15status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round1member15result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round1member15 !!}
                                        ...
                                        <span class="log_output_32"
                                            style="background:gray;">{!! $round1member15result !!}</span>
                                    </div>
                                @endif
                                ...
                                @if ($round1member16status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round1member16result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round1member16 !!}
                                        ...
                                        <span class="log_output_32"
                                            style="background:gray;">{!! $round1member16result !!}</span>
                                    </div>
                                @endif
                            </div>
                        </div>
                            ...
                            <div class="participants">
                                @if ($round1member17status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round1member17result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round1member17 !!}
                                        ...
                                        <span class="log_output_32"
                                            style="background:gray;">{!! $round1member17result !!}</span>
                                    </div>
                                @endif
                                ...
                                @if ($round1member18status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round1member18result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round1member18 !!}
                                        ...
                                        <span class="log_output_32"
                                            style="background:gray;">{!! $round1member18result !!}</span>
                                    </div>
                                @endif
                            </div>
                        </div>
                            ...
                            <div class="participants">
                                @if ($round1member19status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round1member19result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round1member19 !!}
                                        ...
                                        <span class="log_output_32"
                                            style="background:gray;">{!! $round1member19result !!}</span>
                                    </div>
                                @endif
                                ...
                                @if ($round1member20status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round1member20result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round1member20 !!}
                                        ...
                                        <span class="log_output_32"
                                            style="background:gray;">{!! $round1member20result !!}</span>
                                    </div>
                                @endif
                            </div>
                        </div>
                            ...
                            <div class="participants">
                                @if ($round1member21status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round1member21result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round1member21 !!}
                                        ...
                                        <span class="log_output_32"
                                            style="background:gray;">{!! $round1member21result !!}</span>
                                    </div>
                                @endif
                                ...
                                @if ($round1member22status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round1member22result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round1member22 !!}
                                        ...
                                        <span class="log_output_32"
                                            style="background:gray;">{!! $round1member22result !!}</span>
                                    </div>
                                @endif
                            </div>
                        </div>
                            ...
                            <div class="participants">
                                ...
                                @if ($round1member24status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round1member24result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round1member24 !!}
                                        ...
                                        <span class="log_output_32"
                                            style="background:gray;">{!! $round1member24result !!}</span>
                                    </div>
                                @endif
                            </div>
                        </div>
                            ...
                            <div class="participants">
                                @if ($round1member25status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round1member25result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round1member25 !!}
                                        ...
                                        <span class="log_output_32"
                                            style="background:gray;">{!! $round1member25result !!}</span>
                                    </div>
                                @endif
                                ...
                                @if ($round1member26status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round1member26result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round1member26 !!}
                                        ...
                                        <span class="log_output_32"
                                            style="background:gray;">{!! $round1member26result !!}</span>
                                    </div>
                                @endif
                            </div>
                        </div>
                            ...
                            <div class="participants">
                                @if ($round1member27status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round1member27result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round1member27 !!}
                                        ...
                                        <span class="log_output_32"
                                            style="background:gray;">{!! $round1member27result !!}</span>
                                    </div>
                                @endif
                                ...
                                @if ($round1member28status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round1member28result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round1member28 !!}
                                        ...
                                        <span class="log_output_32"
                                            style="background:gray;">{!! $round1member28result !!}</span>
                                    </div>
                                @endif
                            </div>
                        </div>
                            ...
                            <div class="participants">
                                @if ($round1member29status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round1member29result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round1member29 !!}
                                        ...
                                        <span class="log_output_32"
                                            style="background:gray;">{!! $round1member29result !!}</span>
                                    </div>
                                @endif
                                ...
                                @if ($round1member30status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round1member30result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round1member30 !!}
                                        ...
                                        <span class="log_output_32"
                                            style="background:gray;">{!! $round1member30result !!}</span>
                                    </div>
                                @endif
                            </div>
                        </div>
                            ...
                            <div class="participants">
                                @if ($round1member31status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round1member31result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round1member31 !!}
                                        ...
                                        <span class="log_output_32"
                                            style="background:gray;">{!! $round1member31result !!}</span>
                                    </div>
                                @endif
                                ...
                                @if ($round1member32status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round1member32result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round1member32 !!}
                                        ...
                                        <span class="log_output_32"
                                            style="background:gray;">{!! $round1member32result !!}</span>
                                    </div>
                                @endif
                            </div>
                        </div>
                            ...
                            <div class="participants">
                                @if ($round2member5status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round2member5result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round2member5 !!}
                                ...
                                @if ($round2member6status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round2member6result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round2member6 !!}
                                        ...
                                        <span class="log_output_32"
                                            style="background:gray;">{!! $round2member6result !!}</span>
                                    </div>
                                @endif
                            </div>
                        </div>
                            ...
                            <div class="participants">
                                @if ($round2member7status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round2member7result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round2member7 !!}
                                        ...
                                        <span class="log_output_32"
                                            style="background:gray;">{!! $round2member7result !!}</span>
                                    </div>
                                @endif
                                ...
                                @if ($round2member8status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round2member8result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round2member8 !!}
                                        ...
                                        <span class="log_output_32"
                                            style="background:gray;">{!! $round2member8result !!}</span>
                                    </div>
                                @endif
                            </div>
                        </div>
                            ...
                            <div class="participants">
                                @if ($round2member9status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round2member9result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round2member9 !!}
                                ...
                                @if ($round2member10status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round2member10result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round2member10 !!}
                                        ...
                                        <span class="log_output_32"
                                            style="background:gray;">{!! $round2member10result !!}</span>
                                    </div>
                                @endif
                            </div>
                        </div>
                            ...
                            <div class="participants">
                                @if ($round2member11status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round2member11result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round2member11 !!}
                                        ...
                                        <span class="log_output_32"
                                            style="background:gray;">{!! $round2member11result !!}</span>
                                    </div>
                                @endif
                                ...
                                @if ($round2member12status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round2member12result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round2member12 !!}
                                        ...
                                        <span class="log_output_32"
                                            style="background:gray;">{!! $round2member12result !!}</span>
                                    </div>
                                @endif
                            </div>
                        </div>
                            ...
                            <div class="participants">
                                @if ($round2member13status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round2member13result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round2member13 !!}
                                ...
                                @if ($round2member14status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round2member14result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round2member14 !!}
                                        ...
                                        <span class="log_output_32"
                                            style="background:gray;">{!! $round2member14result !!}</span>
                                    </div>
                                @endif
                            </div>
                        </div>
                            ...
                            <div class="participants">
                                @if ($round2member15status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round2member15result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round2member15 !!}
                                        ...
                                        <span class="log_output_32"
                                            style="background:gray;">{!! $round2member15result !!}</span>
                                    </div>
                                @endif
                                ...
                                @if ($round2member16status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round2member16result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round2member16 !!}
                                        ...
                                        <span class="log_output_32"
                                            style="background:gray;">{!! $round2member16result !!}</span>
                                    </div>
                                @endif
                            </div>
                        </div>
                            ...
                            <div class="participants">
                                @if ($round3member3status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round3member3result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round3member3 !!}
                                        ...
                                        <span class="log_output_32"
                                            style="background:gray;">{!! $round3member3result !!}</span>
                                    </div>
                                @endif
                                ...
                                @if ($round3member4status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round3member4result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round3member4 !!}
                                        ...
                                        <span class="log_output_32"
                                            style="background:gray;">{!! $round3member4result !!}</span>
                                    </div>
                                @endif
                            </div>
                        </div>
                            ...
                            <div class="participants">
                                @if ($round3member5status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round3member5result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round3member5 !!}
                                ...
                                @if ($round3member6status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round3member6result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round3member6 !!}
                                        ...
                                        <span class="log_output_32"
                                            style="background:gray;">{!! $round3member6result !!}</span>
                                    </div>
                                @endif
                            </div>
                        </div>
                            ...
                            <div class="participants">
                                @if ($round3member7status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round3member7result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round3member7 !!}
                                        ...
                                        <span class="log_output_32"
                                            style="background:gray;">{!! $round3member7result !!}</span>
                                    </div>
                                @endif
                                ...
                                @if ($round3member8status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round3member8result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round3member8 !!}
                                        ...
                                        <span class="log_output_32"
                                            style="background:gray;">{!! $round3member8result !!}</span>
                                    </div>
                                @endif
                            </div>
                        </div>
                            ...
                            <div class="participants">
                                @if ($round4member3status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round4member3result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round4member3 !!}
                                        ...
                                        <span class="log_output_32"
                                            style="background:gray;">{!! $round4member3result !!}</span>
                                    </div>
                                @endif
                                ...
                                @if ($round4member4status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round4member4result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round4member4 !!}
                                        ...
                                        <span class="log_output_32"
                                            style="background:gray;">{!! $round4member4result !!}</span>
                                    </div>
                                @endif
                            </div>
                        </div>
                            ...
                            <div class="participants">
                                @if ($round5member1status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round5member1result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round5member1 !!}
                                ...
                                @if ($round5member2status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round5member2result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round5member2 !!}
                                        ...
                                        <span class="log_output_32"
                                            style="background:gray;">{!! $round5member2result !!}</span>
                                    </div>
                                @endif
                            </div>
                        </div>
                            ...
                            <div class="participants">
                                @if ($round6member1status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round6member1result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round6member1 !!}
                                        ...
                                        <span class="log_output_32"
                                            style="background:gray;">{!! $round6member1result !!}</span>
                                    </div>
                                @endif
                                ...
                                @if ($round6member2status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round6member2result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round6member2 !!}
                                        ...
                                        <span class="log_output_32"
                                            style="background:gray;">{!! $round6member2result !!}</span>
                                    </div>
                                @endif
                            </div>
                        </div>
