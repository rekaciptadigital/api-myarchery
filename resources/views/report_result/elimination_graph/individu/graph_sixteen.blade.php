                            ...
                            <div class="participants">
                                ...
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        ...
                                        <span class="log_output_32" style="background:gray;">{!! $round1member1result !!}
                                        </span>
                                    </div>
                                @endif
                            ...
                            <div class="participants">
                                @if ($round1member9status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32" style="background:black;">{!! $round1member9result !!}
                                        </span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        ...
                                        <span class="log_output_32"
                                            style="background:gray;">{!! $round1member9result !!}</span>
                                    </div>
                                @endif
                                ...
                                @if ($round1member10status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round1member10result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round1member10 !!}
                                        ...
                                        <span class="log_output_32"
                                            style="background:gray;">{!! $round1member10result !!}</span>
                                    </div>
                                @endif
                            </div>
                        </div>
                            ...
                            <div class="participants">
                                @if ($round1member11status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round1member11result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round1member11 !!}
                                        ...
                                        <span class="log_output_32"
                                            style="background:gray;">{!! $round1member11result !!}</span>
                                    </div>
                                @endif
                                ...
                                @if ($round1member12status === 'win')
                                    <div class="participant32" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        ...
                                        <span class="log_output_32"
                                            style="background:black;">{!! $round1member12result !!}</span>
                                    </div>
                                @else
                                    <div class="participant32" style="background:white;border:1.8px solid gray">
                                        <span class="participant_name"> {!! $round1member12 !!}
                                        ...
                                        <span class="log_output_32"
                                            style="background:gray;">{!! $round1member12result !!}</span>
                                    </div>
                                @endif
                            </div>
                        </div>
