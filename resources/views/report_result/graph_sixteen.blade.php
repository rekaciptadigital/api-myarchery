                            ...
                            <div class="participants">
                                ...
                                @else
                                    <div class="participant" style="background:white;border:1.8px solid gray">
                                        <span> {!! $round1member1 !!} <p class="log_output" style="background:gray;">
                                                {!! $round1member1result !!}</p>
                                        </span>
                                    </div>
                                @endif
                        ...
                        <div class="matchup">
                            <div class="participants">
                                @if ($round1member7status === 'win')
                                    <div class="participant" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        <span> {!! $round1member7 !!} <p class="log_output"
                                ...
                                @if ($round1member8status === 'win')
                                    <div class="participant" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        <span> {!! $round1member8 !!} <p class="log_output"
                                                style="background:black;">
                        ...
                        <div class="matchup">
                            <div class="participants">
                                @if ($round1member9status === 'win')
                                    <div class="participant" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        <span> {!! $round1member9 !!} <p class="log_output"
                                                style="background:black;">
                                ...
                                @if ($round1member10status === 'win')
                                    <div class="participant" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        <span> {!! $round1member10 !!} <p class="log_output"
                                                style="background:black;">
                        ...
                        <div class="matchup">
                            <div class="participants">
                                @if ($round1member11status === 'win')
                                    <div class="participant" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        <span> {!! $round1member11 !!} <p class="log_output"
                                                style="background:black;">
                                ...
                                @if ($round1member12status === 'win')
                                    <div class="participant" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        <span> {!! $round1member12 !!} <p class="log_output"
                                                style="background:black;">
                        ...
                        <div class="matchup">
                            <div class="participants">
                                @if ($round1member13status === 'win')
                                    <div class="participant" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        <span> {!! $round1member13 !!} <p class="log_output"
                                                style="background:black;">
                                ...
                                @if ($round1member14status === 'win')
                                    <div class="participant" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        <span> {!! $round1member14 !!} <p class="log_output"
                                                style="background:black;">
                        ...
                        <div class="matchup">
                            <div class="participants">
                                @if ($round1member15status === 'win')
                                    <div class="participant" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        <span> {!! $round1member15 !!} <p class="log_output"
                                                style="background:black;">
                                ...
                                @if ($round1member16status === 'win')
                                    <div class="participant" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        <span> {!! $round1member16 !!} <p class="log_output"
                                                style="background:black;">
                        ...
                        <div class="matchup">
                            <div class="participants">
                                @if ($round2member1status === 'win')
                                    <div class="participant" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        <span> {!! $round2member1 !!} <p class="log_output"
                                                style="background:black;">
                                ...
                                @if ($round2member2status === 'win')
                                    <div class="participant" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        <span> {!! $round2member2 !!} <p class="log_output"
                                                style="background:black;">
                        ...
                        <div class="matchup">
                            <div class="participants">
                                @if ($round2member3status === 'win')
                                    <div class="participant" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        <span> {!! $round2member3 !!} <p class="log_output"
                                                style="background:black;">
                                ...
                                @if ($round2member4status === 'win')
                                    <div class="participant" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        <span> {!! $round2member4 !!} <p class="log_output"
                                                style="background:black;">
                        ...
                        <div class="matchup">
                            <div class="participants">
                                @if ($round2member5status === 'win')
                                    <div class="participant" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        <span> {!! $round2member5 !!} <p class="log_output"
                                                style="background:black;">
                                ...
                                @if ($round2member6status === 'win')
                                    <div class="participant" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        <span> {!! $round2member6 !!} <p class="log_output"
                                                style="background:black;">
                        ...
                        <div class="matchup">
                            <div class="participants">
                                @if ($round2member7status === 'win')
                                    <div class="participant" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        <span> {!! $round2member7 !!} <p class="log_output"
                                                style="background:black;">
                                ...
                                @if ($round2member8status === 'win')
                                    <div class="participant" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        <span> {!! $round2member8 !!} <p class="log_output"
                                                style="background:black;">
                        ...
                        <div class="matchup">
                            <div class="participants">
                                @if ($round3member1status === 'win')
                                    <div class="participant" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        <span> {!! $round3member1 !!} <p class="log_output"
                                                style="background:black;">
                                ...
                                @if ($round3member2status === 'win')
                                    <div class="participant" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        <span> {!! $round3member2 !!} <p class="log_output"
                                                style="background:black;">
                        ...
                        <div class="matchup">
                            <div class="participants">
                                @if ($round3member3status === 'win')
                                    <div class="participant" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        <span> {!! $round3member3 !!} <p class="log_output"
                                                style="background:black;">
                                ...
                                @if ($round3member4status === 'win')
                                    <div class="participant" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        <span> {!! $round3member4 !!} <p class="log_output"
                                                style="background:black;">
                        ...
                        <div class="matchup">
                            <div class="participants">
                                @if ($round4member1status === 'win')
                                    <div class="participant" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        <span> {!! $round4member1 !!} <p class="log_output"
                                                style="background:black;">
                                ...
                                @if ($round4member2status === 'win')
                                    <div class="participant" style="background:#D4E2FC;border:1.8px solid #0D47A1;">
                                        <span> {!! $round4member2 !!} <p class="log_output"
                                                style="background:black;">
