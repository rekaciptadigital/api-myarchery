...
<body>
    ...
    <td style="width: 150px; height: 86px; border-style: none; text-align: center;">
        <img style="display: block;" src="https://myarchery.id/static/media/myachery.9ed0d268.png" alt="" height="90"/>
    </td>
    <td style="width: 349px; height: 86px; border-style: none; font-size: 12px;text-align: left;float: left;">
        <p style="text-align: left;float: left;"><h3>{{ $event['event_name'] }}</h3></p>
        <p style="text-align: left;float: left;">{{ $category_label }}</p>
    </td>
    <td style="width: 150px; height: 86px; border-style: none; text-align: center;">
        <img style="display: block;" src="https://api.myarchery.id/asset/poster/poster_JAKARTA%20SERIES%20I%20ARCHERY%20COMPETITION%202022.png#1644059999" alt="" height="90"/>
    </td>
    </tr>
    </tbody>
    </table>
    ...
    <tbody>
        ...
        <td style="border-bottom: 1pt solid black;width: 00px; height: 30px;text-align: left;float: left;">Nama</td>
        <td style="border-bottom: 1pt solid black;width: 9px; text-align: center; height: 30px;">:</td>
        <td style="border-bottom: 1pt solid black;width: 340px; height: 30px;text-align: left;float: left;" colspan="3">{{ $data['detail_member']['name'] }}</td>
        <td style="width: 30px; text-align: center; height: 10px;"></td>
        <td rowspan="2" style="padding:10px;background-color: #e3e2de; width: 100px; height: 30px;"><h3>{{ $data['detail_member']['bud_rest_number'] != 0 ? $data['detail_member']['bud_rest_number'] : "" }}{{ $data['detail_member']['target_face'] }}</h3></td>
    </tr>
    <tr style="height: 60px;text-align: left;float: left;">
    <td style="border-bottom: 1pt solid black;width: 100px; height: 30px;text-align: left;float: left;">Klub</td>
    <td style="border-bottom: 1pt solid black;width: 9px; text-align: center; height: 30px;">:</td>
    <td style="border-bottom: 1pt solid black;width: 340px; height: 30px;text-align: left;float: left;" colspan="3">{{ $data['detail_member']['club_name'] }}</td>
    </tr>
    </tbody>
    </table>
<br/>
    ...
    <th style="font-size: 11px; width: 29px; height: 42px; text-align: left;">{{ $category['distance_id'] }}-{{ $data['sesi'] }}</th>
    ...
    <tr style="height: 60px;">
    <td class="border" style="width: 164px; height: 30px;" colspan="4">kode : {{ $data['code'] }}</td>
