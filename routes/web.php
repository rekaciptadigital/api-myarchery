...
$router->group(['prefix' => 'web'], function () use ($router) {
    $router->group(['prefix' => 'v1'], function () use ($router) {
        ...
        $router->group(['prefix' => 'archery', 'middleware' => 'auth.admin'], function () use ($router) {
            ...
            $router->group(['prefix' => 'events'], function () use ($router) {
                ...
                $router->get('/report-result', ['uses' => 'BLoCController@execute', 'middleware' => 'bloc:getArcheryReportResultV2']);
                ...
                $router->get("/report-list-qualification-rank-by-category-id", ['uses' => 'BLoCController@execute', 'middleware' => 'bloc:reportRankQualification']);
                $router->get("/GetDownloadBaganElimination", ['uses' => 'BLoCController@execute', 'middleware' => 'bloc:getDownloadBaganElimination']);
            });
    ...
    $router->group(['prefix' => 'v2'], function () use ($router) {
        ...
        $router->group(['prefix' => 'bud-rest', 'middleware' => 'auth.admin'], function () use ($router) {
            ...
            $router->get('/download-qualification-winner-by-budrest', ['uses' => 'BLoCController@execute', 'middleware' => 'bloc:downloadReportWinnerQualificationByBudrest']);
