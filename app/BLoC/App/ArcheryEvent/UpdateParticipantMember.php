...
class UpdateParticipantMember extends Retrieval
{
    ...
    protected function process($parameters)
    {
        ...
        if ($event_category_detail->category_team == ArcheryEventCategoryDetail::INDIVIDUAL_TYPE) {
            return $this->updateIndividu($participant, $club_id);
        } else {
            Validator::make($parameters->all(), [
                "user_id" => "required|array",
                "team_name" => "required|string"
            ])->validate();
            return "fitur belum selesai";
        }
    }

    private function updateIndividu($participant, $club_id)
    {
    ...
    private function updateTeam()
    {
        ...
        //     throw new BLoCException("tidak dapat mengubah peserta");
        // }
