...
class DownloadEliminationScoreSheet extends Retrieval
{
    ...
    protected function process($parameters)
    {
        ...
        foreach($data_member as $data){
            ...
            $detail_member= ArcheryEventParticipantMember::select('archery_event_participant_members.name as name','archery_clubs.name as club_name',
                            'archery_event_participants.id as participant_id', 'archery_event_participants.user_id as user_id')
