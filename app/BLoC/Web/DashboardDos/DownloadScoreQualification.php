...
class DownloadScoreQualification extends Retrieval
{
    ...
    protected function process($parameters)
    {
        ...
        $session_qualification = $parameters->get('session');
        ...
        if(strtolower($team_category->type) == "individual"){
            ...
            return $this->download($qualification_rank,$category_detail->event_name,$session_qualification,$category_detail->label_category);
        }
        return [];
    }
    ...
    private function download($response, $event_name, $session_qualification,$category_name)
    {
