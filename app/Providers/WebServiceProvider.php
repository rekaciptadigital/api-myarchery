...
use App\BLoC\Web\BudRest\DownloadReportWinnerQualificationByBudrest;
...
class WebServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->registerService("downloadReportWinnerQualificationByBudrest", DownloadReportWinnerQualificationByBudrest::class);
        ...
        $this->registerService("insertAllCategoryEventToSeries", InsertAllCategoryEventToSeries::class);
        ...
        $this->registerService("getArcheryReportResultV2", GetArcheryReportResultV2::class);
        $this->registerService("reportMedalClub", ReportMedalClub::class);
