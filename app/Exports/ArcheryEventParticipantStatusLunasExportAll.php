...
class ArcheryEventParticipantStatusLunasExportAll implements FromView, WithColumnWidths, WithHeadings
{
    ...
    public function view(): View
    {
        ...
        ->where('archery_event_participants.status',1)->where('archery_events.admin_id',$admin->id)->get();
        ...
        return view('reports.participant_event_lunas_all', [
            'datas' => $export_data,
            'event_name'=> '-'
